                  ...
                  >
                    ...
                    <td className="px-6 py-5">
                      ...
                      {perfil.estado ? (
                        ...
                        <span className="inline-flex rounded-full border border-emerald-500/20 bg-emerald-500/10 px-3 py-1.5 text-xs font-bold text-emerald-400">
                          ACTIVO
                        </span>

                      ) : (

                        <span className="inline-flex rounded-full border border-red-500/20 bg-red-500/10 px-3 py-1.5 text-xs font-bold text-red-400">
                          INACTIVO
                        </span>
                    ...
                    <td className="px-6 py-5">
                      ...
                      <div className="flex justify-end gap-2">
                        ...
                        <button
                          type="button"
                          onClick={() => anularPerfil(perfil.idPerfil)}
