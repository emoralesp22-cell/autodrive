  ...
  return (
    <>
      {/* =====================================================
          ...
          NO SE MUESTRA EN CELULAR
      ====================================================== */}
      <aside className="fixed left-0 top-0 z-50 hidden h-screen w-64 flex-col border-r border-white/10 bg-slate-950 text-white shadow-2xl md:flex">
      ...
      {/* =====================================================
          ...
          SOLO SE MUESTRA EN CELULAR
      ====================================================== */}
      <header className="fixed left-0 right-0 top-0 z-50 flex h-16 items-center justify-between border-b border-white/10 bg-slate-950/95 px-4 shadow-xl backdrop-blur-xl md:hidden">

        <div className="flex items-center gap-3">

          {logo ? (
            <div className="flex h-10 w-10 items-center justify-center overflow-hidden rounded-lg bg-slate-900 p-1">
              <img
                src={logo}
                alt="AutoDrive"
          ...
          <div>
            ...
            <p className="text-[8px] font-bold uppercase tracking-widest text-cyan-300">
              Sistema de gestión
            </p>
          </div>
        ...
        <button
          ...
          className="flex h-10 w-10 items-center justify-center rounded-xl border border-white/10 bg-white/5 text-xl text-white transition hover:bg-white/10"
      ...
      {menuAbierto && (
        <>
          ...
          {/* Panel */}
          <div className="fixed right-0 top-16 z-50 w-[85%] max-w-sm overflow-hidden rounded-bl-3xl border-b border-l border-white/10 bg-slate-950 text-white shadow-2xl md:hidden">
              ...
              {opciones.map((opcion) => {
                ...
                return (
                  <button
                    key={opcion.id}
                    type="button"
                    onClick={() => seleccionarSeccion(opcion.id)}
